# Summon System Overhaul - Implementation Plan

## Overview
Complete overhaul of the summon system to create an engaging, balanced gacha experience with proper UI/UX, animations, pity system, and soul-based summoning.

**Current State**: Basic summon configuration exists in `data/summon_config.json` but no UI or functional implementation.

**Goal**: Fully functional summon screen with animations, pity tracking, multi-summon support, and proper god acquisition flow.
...
1. **DATA** - Audit summon config
2. **SYSTEMS** - Create SummonManager
3. **SYSTEMS** - Implement rarity roll with pity
4. **SYSTEMS** - Implement god selection

### Phase 2: UI Foundation (High)
5. **UI** - Create SummonScreen base layout
6. **UI** - Implement banner cards
7. **UI** - Add WorldView summon button

### Phase 3: Summon Flow (High)
8. **INTEGRATION** - Connect to CollectionManager
9. **INTEGRATION** - Integrate with ResourceManager
10. **UI** - Create summon animations

### Phase 4: Features (Medium)
11. **UI** - Implement result display
12. **FEATURES** - Daily free summon
13. **FEATURES** - Summon history

### Phase 5: Polish (Low)
14. **POLISH** - Sound effects and visuals
15. **TESTING** - End-to-end testing
16. **TESTING** - Save/load verification
...
When complete:
- [ ] Player can summon gods using souls, crystals, or mana
- [ ] Pity system guarantees legendary at 100 summons
- [ ] Soft pity increases rates starting at pull 75
- [ ] 10-pull guarantees at least 1 rare or better
- [ ] Daily free summon resets at midnight
- [ ] Summon animations show rarity with color coding
- [ ] All summoned gods added to collection
- [ ] Resources properly deducted
- [ ] Pity counters persist through save/load
- [ ] Summon history viewable

---

## Agent Instructions

1. Read `summon_activity.md` first to see current progress
2. Find next task with `"passes": false`
3. Complete all steps for that task
4. Test using Godot MCP tools or game running
5. Update task to `"passes": true`
6. Log completion in `summon_activity.md` with what was changed
