...
# 		print("Error: ConfigurationManager not found in SystemRegistry")
# 		return null
		
# 	var god_config = config_manager.get_god_config(god_id)
# 	if god_config.is_empty():
# 		print("Error: Could not find god configuration for ID: ", god_id)
# 		return null
	
# 	var god = God.new()
# 	god.id = god_config.get("id", "")
# 	god.name = god_config.get("name", "")
# 	god.pantheon = god_config.get("pantheon", "")
	
# 	# Convert element string to enum
# 	god.element = string_to_element(god_config.get("element", ""))
	
# 	# Convert tier string to enum
# 	god.tier = string_to_tier(god_config.get("tier", ""))
	
# 	# Base stats
# 	var base_stats = god_config.get("base_stats", {})
# 	god.base_hp = base_stats.get("hp", 100)
# 	god.base_attack = base_stats.get("attack", 50)
# 	god.base_defense = base_stats.get("defense", 50)
# 	god.base_speed = base_stats.get("speed", 50)
...
# static func element_to_string(element_type: ElementType) -> String:
# 	match element_type:
# 		ElementType.FIRE:
# 			return "fire"
# 		ElementType.WATER:
...
# func get_ability_names() -> Array:  # Array[String]
...
# func get_passive_ability_descriptions() -> Array:  # Array[String]
...
# func get_buffs() -> Array:  # Array[StatusEffect]
# 	"""Get all buff effects"""
# 	var buffs: Array = []  # Array[StatusEffect]
# 	for effect in status_effects:
...
# func get_debuffs() -> Array:  # Array[StatusEffect]
