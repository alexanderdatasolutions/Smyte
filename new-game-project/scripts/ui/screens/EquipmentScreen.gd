...
func _ready():
	# Get equipment manager through SystemRegistry
	...
	if system_registry:
		...
		if equipment_manager:
			...
			print("EquipmentScreen: EquipmentManager not found in SystemRegistry")
	else:
		print("EquipmentScreen: SystemRegistry not available")
...
func refresh_god_grid():
	...
	# Get gods through SystemRegistry
	var system_registry = SystemRegistry.get_instance()
	...
	if not collection_manager:
		print("EquipmentScreen: CollectionManager not found")
		return
	
	# TODO: Implement proper god access through CollectionManager
	# For now, create placeholder
	var placeholder_label = Label.new()
	placeholder_label.text = "Gods loading through SystemRegistry..."
	god_grid.add_child(placeholder_label)
...
func refresh_equipped_slots():
	...
	for i in range(equipment_slots.size()):
		var equipped = selected_god.equipment[i] if i < selected_god.equipment.size() else null
...
func refresh_stats():
	...
	# Equipment summary
	var equipped_count = 0
	for equip in selected_god.equipment:
		if equip != null:
			equipped_count += 1
...
func _on_slot_clicked(slot_index: int):
	...
	var equipped = selected_god.equipment[slot_index] if slot_index < selected_god.equipment.size() else null
	if equipped:
