...
func calculate_sacrifice_experience(material_gods: Array, target_god: God = null) -> Dictionary:  # Array[God]
...
func perform_sacrifice(target_god: God, material_gods: Array, player_data) -> bool:  # Array[God]
...
func get_sacrifice_preview_text(target_god: God, material_gods: Array) -> String:  # Array[God]
...
func validate_sacrifice(target_god: God, material_gods: Array) -> Dictionary:  # Array[God]
