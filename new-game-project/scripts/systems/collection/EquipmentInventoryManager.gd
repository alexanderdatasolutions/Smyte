...
func _ready():
	...
	print("EquipmentInventoryManager: Initialized")
...
func add_equipment_to_inventory(equipment: Equipment):
	...
	print("EquipmentInventoryManager: Added %s to inventory" % equipment.get_display_name())
...
func remove_equipment_from_inventory(equipment: Equipment) -> bool:
	...
	print("EquipmentInventoryManager: Removed %s from inventory" % equipment.get_display_name())
	return true
...
func equip_equipment_to_god(god: God, equipment: Equipment, slot: int) -> bool:
	...
	print("EquipmentInventoryManager: Equipped %s to %s slot %d" % [equipment.get_display_name(), god.name, slot])
	return true
...
func unequip_equipment_from_god(god: God, slot: int) -> Equipment:
	...
	print("EquipmentInventoryManager: Unequipped equipment from %s slot %d" % [god.name, slot])
	return equipment
...
func clear_inventory():
	...
	print("EquipmentInventoryManager: Inventory cleared")
...
func _test_inventory_operations():
	...
	print("EquipmentInventoryManager: Running tests...")
	...
	print("EquipmentInventoryManager: All tests passed!")
