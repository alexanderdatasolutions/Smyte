...
func get_all_dungeons() -> Array:
	...
	# Elemental sanctums
	var elemental: Dictionary = dungeon_data.get("elemental_sanctums", {})
	for dungeon_id: String in elemental.keys():
		var info: Dictionary = elemental[dungeon_id].duplicate()
		info["id"] = dungeon_id
	...
	# Special sanctums
	var special: Dictionary = dungeon_data.get("special_sanctums", {})
	for dungeon_id: String in special.keys():
		var info: Dictionary = special[dungeon_id].duplicate()
		info["id"] = dungeon_id
	...
	# Pantheon trials
	var pantheon: Dictionary = dungeon_data.get("pantheon_trials", {})
	for dungeon_id: String in pantheon.keys():
		var info: Dictionary = pantheon[dungeon_id].duplicate()
		info["id"] = dungeon_id
	...
	# Equipment dungeons
	var equipment_dungeons: Dictionary = dungeon_data.get("equipment_dungeons", {})
	for dungeon_id: String in equipment_dungeons.keys():
		var info: Dictionary = equipment_dungeons[dungeon_id].duplicate()
		info["id"] = dungeon_id
...
func _get_wave_data(dungeon_id: String, difficulty: String) -> Array:
	...
	var category_data: Dictionary = dungeon_waves.get(category, {})
...
func _enhance_dungeon_info(info: Dictionary) -> void:
...
func get_dungeon_enemies(dungeon_id: String, difficulty: String) -> Array:
	...
	var enemies: Array = []
	var enemy_types: Array = get_enemy_types_for_dungeon(dungeon_id)
